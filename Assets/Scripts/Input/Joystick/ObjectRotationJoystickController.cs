...
/// <summary>
/// Makes a rotation of an object depending of an incoming position of a joystick. 
/// Right now limited to XY rotation.
/// Uses Euler Angles.
/// </summary>
public class ObjectRotationJoystickController : ObjectRotator, IJoystickController
{
	#region Fields
