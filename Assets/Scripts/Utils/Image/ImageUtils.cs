...
namespace Utils
{
	public static class ImageUtils
	{
        ...
        #region Image
        public static IEnumerator SetImage(Image imageComponent, string assetSource, string mimeType = "", bool fillParent = true, MonoBehaviour context = null, float crossFadeAlphaDuration = 0.5f, bool enableImageOnLoaded = true, float alphaOnLoaded = 1)
		{
			...
			getImageRoutine = SpriteUtils.GetSpriteFromSource(assetSource, (result) => ApplySprite(imageComponent, fillParent, result, crossFadeAlphaDuration, enableImageOnLoaded, alphaOnLoaded), requestKey); ;
		...
		public async static void LoadImage(Image imageComponent, MonoBehaviour monoBehaviourInstance, Wezit.Node wzData, string targetRelation = "relationForShowPicture", string targetWzSourceTransformation = "original", bool fillParent = true, float crossFadeAlphaDuration = 0.25f)
		{
		...
		#region RawImage
		public static IEnumerator SetImage(RawImage imageComponent, string assetSource, string mimeType = "", bool fillParent = true, MonoBehaviour context = null, float crossFadeAlphaDuration = 0.5f, bool enableImageOnLoaded = true, float alphaOnLoaded = 1)
		{
			if(mimeType == "image/webp")
            {
				WebpAnimation.LoadAndApplyWebp(assetSource, imageComponent, fillParent, false, crossFadeAlphaDuration, enableImageOnLoaded, alphaOnLoaded);
				yield break;
			}
			...
			IEnumerator getTextureRoutine = SpriteUtils.GetTextureFromSource(assetSource, (result) => ApplyTexture(imageComponent, fillParent, result, crossFadeAlphaDuration, enableImageOnLoaded, alphaOnLoaded), requestKey);
		...
		public async static void LoadImage(RawImage imageComponent, MonoBehaviour monoBehaviourInstance, Wezit.Node wzData, string targetRelation = "relationForShowPicture", string targetWzSourceTransformation = "original", bool fillParent = true, float crossFadeAlphaDuration = 0.25f)
		{
			if (imageComponent != null)
			{
				if (wzData != null)
		...
		public async static void LoadCover(RawImage imageComponent, MonoBehaviour monoBehaviourInstance, Wezit.Node wzData, string targetRelation, string targetWzSourceTransformation = "original", bool fillParent = true, float crossFadeAlphaDuration = 0.25f)
		{
			if (imageComponent != null)
			{
				if (wzData != null)
